                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: Center(child: TextStyleWidget(title: Strings.placedOrder.tr, size: 12.sp,weight: FontWeight.w400,color: MyColors.yellow,)),
                                    ),
                                  ],
                                ),
                            ...
                            TextFormField(
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(color: MyColors.white50,width: 1.w),
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: TextStyleWidget(title: Strings.cancelOrder.tr, size: 14.sp,color: MyColors.primaryGreen,weight: FontWeight.w400,),
                            ),
                          ),
                          GestureDetector(
                            onTap: (){},
                            child: Container(
                              ...
                              child: TextStyleWidget(title: Strings.edit.tr, size: 14.sp,color: MyColors.white,weight: FontWeight.w400,),
                            ),
                          ),
